...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~ZOQReKTQhwzRPN9dOPuy", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "50934953846", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝘾𝙃𝙄𝘾𝙊✮𝙈𝙋𝙆🍷", // Input Yours custom...(Maintain font for Flow)
